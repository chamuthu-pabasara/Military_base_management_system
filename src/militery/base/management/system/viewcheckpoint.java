 ...
 * @author M S I
 */
public class viewcheckpoint extends javax.swing.JFrame {
     MongoClient mongo;
     MongoDatabase db;
     MongoCollection<org.bson.Document> collection;
    /**
     * Creates new form viewcheckpoint
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Check points Details");
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(279, 47, 840, 700));
...
String fieldValue1 = result.getString("Soldiers"); // Replace "field1" with the actual field name in your document
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewcheckpoint.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewcheckpoint().setVisible(true);
            }
        });
    }
